...
- Dua Kecenderungan Pola Jawaban: Setiap mesin AI Search memiliki dua arah kecenderungan utama saat merespons instruksi pengguna:
  1. Discovery / Definition-Based: Pola jawaban yang hanya berfokus pada penjelasan teks, deskripsi teoritis, dan definisi umum dari pertanyaan penanya.
  2. Evaluation / Entity-Based: Pola jawaban tingkat lanjut yang secara aktif melibatkan, menyebutkan, dan merekomendasikan entitas bisnis nyata sebagai solusi konkret, bukan sekadar teori teks.
...
1. Analisis Jalur Pertanyaan Lanjutan (Follow-Up Question Mapping):
...
2. Pengujian Penyelaman Manual (Manual In-Depth Protocol):
...
1. Pengujian Hierarki Atas ke Bawah (Top-Down: Brand & Competence Validation):
...
2. Pengujian Hierarki Bawah ke Atas (Bottom-Up: Entity Core Validation):
...
3. Pengujian Kognisi Tak Langsung (Indirect Entity & Spatial Awareness Test):
...
------------------------------------------------------------------------
2. TAHAP 2: INTEROGASI TOPIK SPASIAL & SPESIFIK KATEGORI KOMPETENSI
------------------------------------------------------------------------
